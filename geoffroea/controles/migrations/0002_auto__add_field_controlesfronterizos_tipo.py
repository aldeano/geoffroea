...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ControlesFronterizos.tipo'
        db.add_column(u'controles_controlesfronterizos', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='terrestre', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ControlesFronterizos.tipo'
        db.delete_column(u'controles_controlesfronterizos', 'tipo')
