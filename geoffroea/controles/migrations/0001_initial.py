...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'controles_tipousuario', (
        ...
        db.send_create_signal(u'controles', ['TipoUsuario'])
        ...
        db.create_unique(m2m_table_name, ['controlesfronterizos_id', 'user_id'])

        # Adding model 'Dia_CCFF_Terrestre'
        db.create_table(u'controles_dia_ccff_terrestre', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('inspector', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ...
        db.create_table(u'controles_pasajero', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('inspector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.create_table(u'controles_abandono', (
            ...
            ('inspector', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['controles.TipoUsuario'])),
        ...
        db.create_table(u'controles_turno', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('jefe_turno', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['controles.TipoUsuario'])),
            ('sgte_jefe_turno', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['controles.TipoUsuario'])),
        ...
        db.create_table(m2m_table_name, (
            ...
            ('tipousuario', models.ForeignKey(orm[u'controles.tipousuario'], null=False))
        ))
        db.create_unique(m2m_table_name, ['turno_id', 'tipousuario_id'])
        ...
        db.create_table(u'controles_acta_intercepcion', (
            ...
            ('inspector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['controles.TipoUsuario'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'controles_tipousuario')
