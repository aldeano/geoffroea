...
urlpatterns = patterns('',
    ...
    url(r'^modificar_ccff/(?P<slug>[-\w]+)/$', login_required(ModificarCCFF.as_view()), name="modificar_ccff"),
    url(r'^borrar_ccff/(?P<slug>[-\w]+)/$', login_required(BorrarCCFF.as_view()), name="borrar_ccff"),
    ...
    url(r'^modificar_insp/(?P<slug>[-\w]+)/$', login_required(ModificarInspector.as_view()), name="modificar_insp"),
    url(r'^borrar_insp/(?P<slug>[-\w]+)/$', login_required(BorrarInspector.as_view()), name="borrar_insp"),
